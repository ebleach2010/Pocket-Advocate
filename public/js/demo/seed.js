...
export function seed({ set, file }) {
  ...
  REC('r-demo-1', {
    ...
    chart: { line: 'Above VWAP · EMAs stacked up · MACD just crossed up', at: hours(2.05) },
  ...
  REC('r-demo-3', {
    ...
    chart: { line: 'Above VWAP · EMAs mixed · MACD above signal', at: hours(2.05) },
  ...
  REC('r-demo-5', {
    ...
    chart: { line: 'Above VWAP · EMAs stacked up · MACD above signal', at: hours(5.05) },
