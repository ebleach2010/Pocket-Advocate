...
// arrow key. Tapping the page itself does NOT turn it.
//
...
export function mountPages({ container, pages, storageKey = '', groups = null } = {}) {
  ...
  // space between bubbles threw him onto another page with nothing on screen
  // to say what he had done. The tab strip, the sideways swipe and the arrow
  // keys all remain, and all three announce themselves before you commit.
