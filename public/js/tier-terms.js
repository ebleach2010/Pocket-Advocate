...
• An active window of <strong>60 days</strong>, starting the day you buy it.</p>
<h3>About that 60 days, and the two appeals</h3>
<p>The window governs the <strong>coordination</strong>: the check-ins, the calls I make for you, the records I chase, the first appeal I file. When the window ends, the case wraps up - not at any particular call, and never by surprise, because we will have spoken at least twice a month on the way there.</p>
...
<p>If you want more coordination time than 60 days, <strong>another 30 days at a time</strong> is available from the Case Enhancements tab on your case page, as many times as you need it. You will be told the price before anything is charged, and you are never obliged to take it.</p>
<h3>Your readiness checklist, and the clock</h3>
<p>Before I can act for you, your case page asks you to complete a short checklist: two separate documents, because they do two different legal jobs and neither one covers the other:</p>
...
<p>Both are signed on your case page and either can be withdrawn in writing at any time. Until the checklist is done I cannot phone anyone on your behalf, and I want to be straight with you about the consequence: <strong>the 60 days runs from the day you buy, whether or not the checklist is done.</strong> How fast you finish your part is up to you. Finish it early and you get all of it.</p>
...
<p>The Hands-Off fee is charged once, at the price shown when you buy it, and you can spread it over time at checkout if that is what makes it possible. If I cannot get the authority to act, because the authorisation is never signed or your insurer details never arrive, and no records request has gone out, the fee refunds down to the price of a standard Advocacy Case, which is the work I will have done. Once records requests are out, the standard non-refundable terms apply. A check-in you miss or decline is never a refund basis. Extensions are charged separately, only if you ask for one.</p>
