// Full-Service Case Management: the scope note the client acknowledges before
...
export const FULL_ACCESS_TERMS = {
  id: 'fullAccess',
  title: 'Full-Service Case Management: what it covers',
  body: `
<h3>What is different about Full-Service Case Management</h3>
<p>In a standard case I work <strong>beside</strong> you: I read, I explain, and I prepare you to carry it to your own doctors and your insurer. With Full-Service Case Management I work <strong>inside</strong> the case. <strong>I do the legwork.</strong> I speak to your clinics and your insurance company myself, either with you on the line or alone once you have authorised it, and I write your insurance appeals.</p>
<h3>What is included</h3>
<p>Everything in a standard Advocacy Case, at no separate charge, which is our initial case overview call, my review of your records, and the written report. Then <strong>up to 20-22 hours of comprehensive advocacy during each 30-day service period</strong>, with <strong>priority access maintained throughout the month</strong>. Out of those hours:</p>
...
• Calls to your clinics and your insurer on your behalf. I do not meter them call by call; they draw from the month's advocacy hours.<br>
• <strong>Insurance appeals, written by me</strong>: the first-level internal appeal, the escalation if it is denied, and the one after that if there is one. Appeals are not counted as items either; the writing draws from the same hours.<br>
...
<p>Twenty hours is a great deal of advocacy, and most months use less than that. If your case genuinely needs more, we talk first: <strong>additional substantive casework beyond the included hours is billed at $175 to $225 an hour</strong>, agreed with you in advance, never discovered on a bill afterwards.</p>
...
<p>If you upgrade <strong>before your written report has arrived</strong>, Full-Service takes over from that day: the report still arrives as promised, and from that day the work runs on the Full-Service clock and its hours.</p>
...
<h3>What Full-Service Case Management is NOT</h3>
...
<p>Records requests can take up to 30 days by law and often use most of it. Specialist referrals commonly run 4 to 12 weeks. Insurers generally answer an internal appeal in 30 to 60 days, faster only when the case is genuinely urgent. Full-Service Case Management does not make any of those clocks run faster; it means somebody who knows them is running yours.</p>
...
<p>You are charged <strong>one month at a time</strong>, at the price you were quoted when you asked - not whatever the rate has moved to while your request sat with me. <strong>The Advocacy Case and Full-Service Case Management are separate services, priced separately:</strong> your case fee paid for the review you already received, and it is not credited against your first month. Nothing is charged unless and until I approve your request.</p>
