  ...
  const rateBlock = rate ? `
    <details class="panel" style="margin-bottom:1rem;">
      ...
      <p class="dim small" style="margin:.5rem 0 .6rem;">Follow-up
        ...
        Priority Chat <strong style="color:var(--ink)">$${dollars(rate.subCents || 15000)}/mo</strong>,
        Full Access <strong style="color:var(--ink)">$${dollars(rate.fullCents || 260000)}</strong>.
      ...
      <div class="row" style="gap:.5rem; flex-wrap:wrap;">
        ...
        <label class="dim small">Chat $/mo
          <input type="number" id="rate-sub" min="10" max="250" step="1" value="${((rate.subCents || 15000) / 100)}"
