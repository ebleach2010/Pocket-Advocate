...
<p><strong>You can still leave a review</strong>, and I would rather you did. A closed case is exactly the situation where somebody's honest account is worth the most, and a service that only collects feedback from the people it kept happy is not collecting feedback at all. The review card on your case page stays open, and so does <a href="https://g.page/r/CUKWU6xlposHEAE/review" target="_blank" rel="noopener noreferrer">my Google review page</a>.</p>
