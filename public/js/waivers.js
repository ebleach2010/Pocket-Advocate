...
<p>Exactly two parties: <strong>you</strong> and <strong>me, your advocate</strong>. Access is enforced by security rules on every document and file. If you elect a public session (a separate, explicit choice), the live discussion itself is broadcast — your uploaded files and case file are never public.</p>
...
<p>By acknowledging this form you give written consent for me to record the audio and video of your discussion, whether it takes place over Discord, Zoom, or phone. This written consent is collected from every participant before any recording begins, which satisfies the all-party consent laws of states such as California, Washington, and Florida.</p>
<h3>Where the recording goes</h3>
<p>Into your case file, visible only to you and me — unless you separately and explicitly elect a public session on the next screen. You can revoke a public election any time before the broadcast starts.</p>`,
  },
];
...
<p>$19.99 per month through Stripe, renewed automatically. Cancel anytime from the Manage Subscription page — access runs to the end of the period you already paid for, and your message history stays visible to you. If a renewal payment fails, access likewise runs out at the end of the paid period.</p>
