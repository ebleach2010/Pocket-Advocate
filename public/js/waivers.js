...
//   (a) Disclaimer, Payment section: the follow-up add-on is named as its own
//       $75 session rather than a bundled inclusion. Same one-month expiry,
//       same non-refundable terms as before.
//   (b) SUBSCRIPTION_TERMS, Billing & cancellation: "$24.99 per month through
//       Stripe" is now "$50 per month through Stripe".
...
<p>Pocket Advocate is a <strong>patient-advocacy</strong> service offered to residents of the United States and Canada. I help you navigate your medical journey: organizing your story, helping you understand your labs and imaging in plain language, preparing questions to bring to your doctors, and identifying options to discuss with your care team.</p>
...
• <strong>Not a doctor-patient relationship</strong>, and not a substitute for one. I am not acting as your physician or clinician.<br>
• <strong>Not therapy and not emergency care.</strong> If this is an emergency, call 911.</p>
<h3>The advocacy relationship</h3>
<p>By purchasing an Advocacy Case you engage me to review the materials you choose to share, discuss them with you, and prepare a written advocacy summary. You remain responsible for all decisions about your health, made together with your own licensed care team. You agree to share the advocacy summary with your care team before acting on anything in it.</p>
...
<h3>Payment</h3>
<p>The Advocacy Case fee (and the optional $75 follow-up session) is <strong>non-refundable</strong> once your time slot is booked. A follow-up session must be used within <strong>one month of your first discussion</strong>; unused follow-ups expire (you'll get a reminder a week before). 24/7 Priority Chat is separate: cancel it anytime, and access simply runs to the end of the period you already paid for.</p>
...
<p>Exactly two parties: <strong>you</strong> and <strong>me, your advocate</strong>. Access is enforced by security rules on every document and file. Every discussion is private — there is no public or broadcast option.</p>
...
<p>By acknowledging this form you give written consent for me to record the audio and video of your discussion, whether it takes place by phone or video call. This written consent is collected from every participant before any recording begins, which satisfies the all-party consent laws of states such as California, Washington, and Florida.</p>
<h3>Where the recording goes</h3>
<p>Into your case file, visible only to you and me. Every session is private: recordings are never broadcast, published, or shared with anyone else.</p>`,
  },
];
