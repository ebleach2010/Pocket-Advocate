...
//       first discussion - it is bought from the case after the report lands
//       (Eric, 2026-08-20), so the old wording described a product that no
//       longer exists. Original text otherwise byte-identical.
//   (a-old) The follow-up add-on is named as its own
