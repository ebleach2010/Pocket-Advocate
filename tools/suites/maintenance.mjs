...
// Moved out from 1PM, then again to 8PM, on Eric's word (2026-08-25). MST is
// a fixed UTC-7, so 8PM MST is 03:00Z the NEXT calendar day - the 08-26 in
// this timestamp is still the same evening to anyone reading it in Mountain time, and getting
// that wrong by a day is exactly the mistake this check exists to catch.
check('M2 that instant is 8PM MST on 2026-08-25 (MST is a fixed UTC-7)',
  workerUntil === '2026-08-26T03:00:00Z', workerUntil);
