...
subscription Checkout ($19.99/mo) → chat unlocks immediately, showing Eric's live online
...
| Item | Cost |
|---|---|
| Stripe, $150 case | 2.9% + 30¢ ≈ **$4.65** (+$1.45 on the $50 add-on) |
| Stripe, $19.99/mo subscription | ≈ 88¢ + Stripe Billing's small % per cycle |
...
1. **Refund/cancel + no-show policies** — the §C proposals need a yes/no.
   ✅ **Partially decided (2026-07-13): the $150 case fee (and $50 add-on) is
   non-refundable once the slot is booked** — stated in waiver 1's Payment
   section and at checkout. The $19.99/mo subscription cancels anytime via the
...
3. **Domain / public brand name** — "TheBroScientist Neuro Advocacy" with Pocket
   ...
   ✅ **Decided (2026-07-11): the web app is called "Pocket Advocate."** The $19.99/mo
...
4. **Follow-up add-on details** — booking deadline after the report (e.g. within 60
   ...
   follow-up, or charge a custom rate (0–150% of $150 in 25% steps) with an
